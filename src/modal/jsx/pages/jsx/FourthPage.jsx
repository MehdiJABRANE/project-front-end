...
export default function FourthPage({mainObject, pageNum, setPageNum, filtersArray, setFiltersArray, checkedItems, setCheckedItems}){
        ...
        <>
            <div className='p4-body-content'>
                ...
                <div className='p4-middle-content'>
                    ...
                    <FilterModal mainObject={mainObject} filterIsShow={filterIsShow} setFilterIsShow={setFilterIsShow} setFiltersArray={setFiltersArray} filtersArray={filtersArray} checkedItems={checkedItems} setCheckedItems={setCheckedItems} />
                </div>
