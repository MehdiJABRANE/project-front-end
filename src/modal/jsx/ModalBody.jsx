    ...
    return(
        <>
            <Modal.Body className='body'>
                ...
                <ModalRight pageNum={pageNum} setPageNum={setPageNum} setIsShow={setIsShow} mainObject={mainObject} setMainObject={setMainObject} checkedItems={checkedItems} setCheckedItems={setCheckedItems} />
            </Modal.Body>
        </>
    )
}